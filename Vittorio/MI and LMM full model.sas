...
proc mixed data=alzheimer_long_centered method=REML;
    by _Imputation_;
    class sex patid;
    model bprs =  trial sex age edu bmi inkomen job
          adl wzc cdrsb_base
          ab_base tau_base
          time
          trial*time sex*time age*time edu*time bmi*time inkomen*time
          job*time adl*time wzc*time cdrsb_base*time
          ab_base*time tau_base*time
                  / solution;
...
proc mianalyze parms=results;
    modeleffects Intercept trial sex age edu bmi inkomen job
          adl wzc cdrsb_base
          ab_base tau_base
          time
          trial*time sex*time age*time edu*time bmi*time inkomen*time
