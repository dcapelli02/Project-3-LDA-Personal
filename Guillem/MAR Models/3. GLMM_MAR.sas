...
/* For the GLMM model, the same version as the primary model is valid under MAR!
This is because Generalized Linear Mixed Models fitted with the Adaptive Gaussian Quadrature are likelihood-based. 
